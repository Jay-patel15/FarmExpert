                ...
                <div class="card shadow-lg p-3 mb-5 bg-white rounded mr-5">
                    <div class="card-body text-center" style="height:500px">
                        <ul class="nav nav-pills pl-2 pr-1 mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-farmer-tab" data-toggle="pill" style="width:122px" href="#pills-farmer" role="tab" aria-controls="pills-farmer" aria-selected="true">Farmer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-customer-tab" data-toggle="pill" style="width:122px" href="#pills-customer" role="tab" aria-controls="pills-customer" aria-selected="false">Customer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-government-tab" data-toggle="pill" style="width:122px" href="#pills-government" role="tab" aria-controls="pills-government" aria-selected="false">Government</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-2 pl-1" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-farmer" role="tabpanel" aria-labelledby="pills-farmer-tab">
                                <form method="POST" class="text-center border border-light p-5" style="height:350px" action="php/login.php">
                                    ...
                                    <p>Not a member? <a href="php/farmer_regist.php" style="color: #AA9A6E;">Register</a></p>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-customer" role="tabpanel" aria-labelledby="pills-customer-tab">
                                <form class="text-center border border-light p-5" action="php/login.php" method="POST">
                                    ...
                                    <p>Not a member? <a href="php/user_register.php" style="color: #AA9A6E;">Register</a></p>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-government" role="tabpanel" aria-labelledby="pills-government-tab">
                                <form class="text-center border border-light p-5" action="php/login.php" method="POST">
                                    ...
                                    <!-- <p>Not a member? <a href="php/govt_regist copy.php" style="color: #AA9A6E;">Register</a></p> -->
                                </form>    
                            </div>
                        </div>     
                    </div>
