			...
			<span class="menu"><img src="images/nav.png" alt=""/></span>
				<div class="top-menu">
					...
					<nav class="cl-effect-13">
						...
						<li><a href="https://services.india.gov.in/service/detail/pm-kisan-samman-nidhi-1" target="_blank">News</a></li>
				...
				<h1><a href="farmer_index.php">Agriculture</a></h1>
					...
					<div class="header-grids   text-center">
						<div class="header-bottom-grid1 col-md-offset-1 ">
							...
							<h4><a href="crop_predict.php" style="color:white;">Crops Prediction</a></h4>
						</div>
						
						<div class="header-bottom-grid2">
							<span class="glyphicon glyphicon-leaf"></span>
							<h4><a href="plant_disease.php" style="color:white;">Disease Prediction</a></h4>
						</div>
					...
					<div class="header-bottom-grids text-center">
						...
						<div class="header-bottom-grid2 ">
							...
							<h4><a href="fertilizer_recomendation.php" style="color:white;">Fertilizer Prediction</a></h4>
						</div>
